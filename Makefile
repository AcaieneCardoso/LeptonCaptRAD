#############################################################################
# Makefile for building: lepton3
# Generated by qmake (2.01a) (Qt 4.8.7) on: ter out 29 10:23:38 2019
# Project:  lepton3.5_viewer.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt4/bin/qmake -o Makefile lepton3.5_viewer.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -I../sdk -Igen_mocs
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/arm-linux-gnueabihf -L../sdk/leptonSDKEmb32PUB/Debug -lLEPTON_SDK -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		lepton3.5_viewer.pro
QMAKE_TARGET  = lepton3
DESTDIR       = 
TARGET        = lepton3
...
Makefile: lepton3.5_viewer.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile lepton3.5_viewer.pro
...
dist: 
	@$(CHK_DIR_EXISTS) gen_objs/lepton31.0.0 || $(MKDIR) gen_objs/lepton31.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) gen_objs/lepton31.0.0/ && $(COPY_FILE) --parents Lepton_I2C.h LeptonThread.h MyLabel.h Palettes.h SPI.h gen_objs/lepton31.0.0/ && $(COPY_FILE) --parents Lepton_I2C.cpp LeptonThread.cpp main.cpp MyLabel.cpp Palettes.cpp SPI.cpp gen_objs/lepton31.0.0/ && (cd `dirname gen_objs/lepton31.0.0` && $(TAR) lepton31.0.0.tar lepton31.0.0 && $(COMPRESS) lepton31.0.0.tar) && $(MOVE) `dirname gen_objs/lepton31.0.0`/lepton31.0.0.tar.gz . && $(DEL_FILE) -r gen_objs/lepton31.0.0
...
sdk:
	make -C ../sdk/leptonSDKEmb32PUB

sdkclean:
	make -C ../sdk/leptonSDKEmb32PUB clean
